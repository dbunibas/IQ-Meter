...
public class PanelChart extends PannelloPing{

    private JFXPanel fxPanel = new JFXPanel();
    private Log logger = LogFactory.getLog(this.getClass());
    private XYChart chart;
    private FxEffortQualityChart fxChart;
    ...
    public void inizializza() {
        ...
        fxChart = new FxEffortQualityChart(fxPanel);
    ...
    public FxEffortQualityChart getFxChart() {
        return fxChart;
    }
