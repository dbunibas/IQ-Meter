...
public class PanelChartTemporal extends PannelloPing{

    private JFXPanel fxPanel = new JFXPanel();
    private Log logger = LogFactory.getLog(this.getClass());
    private XYChart chart;
    private FxEffortQualityChartTemporal fxChart;
    private Runnable threadFx;

    /**
     * Creates new form PanelChart
     */
    public PanelChartTemporal() {
    }
    ...
    public void inizializza() {
        ...
        fxChart = new FxEffortQualityChartTemporal(fxPanel);
    ...
    public FxEffortQualityChartTemporal getFxChart() {
        return fxChart;
    }
