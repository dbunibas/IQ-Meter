...
public class PanelChartClickTemporal extends PannelloPing{

    private JFXPanel fxPanel = new JFXPanel();
    private Log logger = LogFactory.getLog(this.getClass());
    private FxRecordedQualityChartTemporal fxChart;
    private Runnable threadFx;

    /**
     * Creates new form PanelChart
     */
    public PanelChartClickTemporal() {
    }
    ...
    public void inizializza() {
        ...
        fxChart = new FxRecordedQualityChartTemporal(fxPanel);
    ...
    public FxRecordedQualityChartTemporal getFxChart() {
        return fxChart;
    }
